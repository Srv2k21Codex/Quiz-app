...
let questions = [
    {
        prompt: `How cna a variable be declared in
                 javascript ?`,
        options: [
            "var strname",
            "strname var",
    ...
    {
        prompt: `which is NOT a comparison
    ...
    {
        prompt: `The stylesheet file will not be
                  loaded by the browser if you omit`,
        options: ["REL", "STYLE", "BODY", "HTML"],
        answer: "REL",
    },

    {
        prompt: `what are the three important 
                  manipulations for a loop on a loop
                  variable.`,
        options: [
